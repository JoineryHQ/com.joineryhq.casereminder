 ...
 * (GenCodeChecksum:765d500bf4dbe7938378380ec1b68762)
 */
...
class CRM_Casereminder_DAO_CaseReminderType extends CRM_Core_DAO {
  ...
  /**
   * Implicit FK to civicrm_option_value where option_group = from_email_address
   *
   * @var int|string|null
   *   (SQL type: int unsigned)
   *   Note that values will be retrieved from the database as a string.
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'from_email_address_id' => [
          ...
          'description' => E::ts('Implicit FK to civicrm_option_value where option_group = from_email_address'),
          'usage' => [
            'import' => FALSE,
            'export' => FALSE,
            'duplicate_matching' => FALSE,
          ...
          'where' => 'civicrm_case_reminder_type.from_email_address_id',
          'table_name' => 'civicrm_case_reminder_type',
          'entity' => 'CaseReminderType',
          'bao' => 'CRM_Casereminder_DAO_CaseReminderType',
          'localizable' => 0,
